...
async function createExam(req, res, next) {
  try {
    ...
    const { title, subject, teacher_id, question_bank_id, duration_minutes, start_time, end_time, room, exam_code } = req.body;
...
async function updateExam(req, res, next) {
  try {
    ...
    const { title, subject, teacher_id, question_bank_id, duration_minutes, start_time, end_time, room } = req.body;
    const data = {};
