...
/// Font body & UI: Inter.
/// Jangan pakai font ketiga di luar dua ini.
class AppTypography {
  AppTypography._();
  ...
  /// "EXAM SCHEDULE" heading halaman — Barlow Condensed ExtraBold 32sp.
  static TextStyle get pageTitle => GoogleFonts.barlowCondensed(
        fontSize: 32,
        fontWeight: FontWeight.w800,
        color: AppColors.textPrimary,
        height: 1.0,
  ...
  /// Nama siswa (DANANG PRAKOSO) — Inter Bold 20sp.
  static TextStyle get studentName => GoogleFonts.inter(
        fontSize: 20,
